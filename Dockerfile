...
RUN apt-get update  && \
    ...
    apt-get install -y libcurl4-gnutls-dev libxml2-dev libbz2-dev  zlib1g-dev libssl-dev libtidy-dev libxslt1-dev libmagic-dev libexif-dev file libssh2-1-dev git curl wget unzip libjpeg62-turbo-dev libpng-dev libfreetype6-dev sendmail && \
    apt-get clean && \
